...
window = Tk()
window.title("SignUp")
window.geometry("925x500+300+200")  # Corrected geometry specifier
...
signin=Button(frame,width=6,text="Sign in",border=0,background="white",cursor="hand2",fg="#57a1f8",command=sign)
